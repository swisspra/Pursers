...
def test_exact_view_lock_and_embedded_external_attestation_boundary() -> None:
    ...
    expected = "c4dc86239b836a801870d2c8ee228110c325cd32fbd91348e3a18300893b2d51"
    assert len(payload) == 404_280
    assert hashlib.sha256(payload).hexdigest() == expected
    assert lock["product_version"] == PRODUCT_VERSION == "5.0.0a10"
    assert lock["view"] == {
...
async def test_app_reads_leave_sqlite_domain_journal_and_cursor_unchanged(
    ...
    required = {"pursers-central": "0.1.0a16", "pursers-client": "0.1.0a13"}
