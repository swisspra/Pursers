...
The runtime continuation also imports the observer-only delta from
`TK-fa155aa34187` remote tip
`codex/TK-fa155aa34187-resubmit-2@4d9d20b5f6a0c43289eeebb8c520b87d183a198b`:
...
branch was preserved across the observer import. This integration adds a
deterministic installed-candidate manifest and signed live-listener identity
proof because the supported AionCore 0.2.1 host serves extension assets but
does not execute packaged `/pursers/status` handlers. The submitted observer
input and this non-mechanical contract change receive fresh review; no
observer-ticket approval is asserted.
