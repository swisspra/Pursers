...
const ERROR_COPY = {
  ...
  runtime_context_missing: 'Open this page from an existing AionUi Team conversation, then retry.',
  ...
  transport_unavailable: 'The AionUi Team helper is unavailable. Nothing changed.',
