...
- AionUi tag `v2.2.1`, commit `dc47f4a0173ff506b08f13c97b10944d61e422d5`:
...
- AionCore tag `v0.2.1`, commit `a9e113437a5cf0552075de618ee9458be24ef756`:
  `crates/aionui-extension/src/types.rs`, `manifest.rs`, `permission.rs`, and
  `constants.rs`.
- AionHub `main`, inspected 2026-09-07: public `aion-extension.json` examples
