...
def _detail_ticket(
    ticket: dict[str, Any], handoff: dict[str, Any] | None = None
) -> dict[str, Any]:
...
def project_board_detail(
    ...
    tickets = [
        _detail_ticket(item, handoffs_by_ticket.get(str(item.get("ticket_id") or "")))
