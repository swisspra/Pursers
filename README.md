...
| Package | What it is |
| --- | --- |
| `pursers==5.0.2` | Installs Central, the client, Personal, and the importer |
| `pursers-central==0.1.1` | The board service |
| `pursers-client==0.1.1` | Async Python client |
| `pursers-personal==5.0.2` | One-owner board and MCP App dashboard |
...
`pursers==5.0.2`, `pursers-personal==5.0.2`,
`pursers-personal-import==5.0.0`, `pursers-central==0.1.1`,
`pursers-client==0.1.1`, `pursers-wait-bridge==0.1.0`, and
`pursers-acp==0.1.0`.
